# Generated by Powerlevel10k configuration wizard on 2023-06-08 at 08:53 PDT.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=004
  # Custom icon.
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=006
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%m.%d.%Y %H:%M:%S}'
